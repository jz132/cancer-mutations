...
entropy_paths <- c("dataset/bg_entropy_data/enhancer_entropy.csv", "dataset/bg_entropy_data/promoter_entropy.csv") #c("dataset/epdata/enhancer_entropy.csv", "dataset/epdata/promoter_entropy.csv")
cis_annotated_paths <- c("dataset/cis_annotated/enhancer_annotated.csv", "dataset/cis_annotated/promoter_annotated.csv") #c("dataset/annotated/enhancer_annotated.csv", "dataset/annotated/promoter_annotated.csv")
cistypes <- c("enhancer", "promoter") #c("enhancer", "promoter")
cislen <- length(cistypes)

outdir <- "dataset/combined_predictions"
...
p_cis_df <- z_cis_df %>% mutate_all(~ 2*(1-pnorm(abs(.))))
...
write.csv(mutated_max_effect_per_cis, paste0(outdir,"/",cisname,"_muteffect.csv"), quote=FALSE, row.names=FALSE)
...
write.csv(max_effect_per_gene, paste0(outdir,"/",cisname,"_gene_muteffect.csv"), quote=FALSE, row.names=FALSE)
