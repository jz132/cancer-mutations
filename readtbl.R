...
# ============ PATH INFORMATION ============ 
icgc_mut_path <- "<input_to_icgc_ssm_data>"
icgc_mut_outpath <- "dataset/icgc_processed/icgc_exp_LIRI_JP"

icgc_exp_path <-"<input_to_icgc_exps_data>"
icgc_exp_outpath <- "dataset/icgc_processed/icgc_exp_LIRI_JP"

exon_path <- "dataset/epdata/all_exons_refseq.txt"
