...
cis_annotated_paths <- c("dataset/cis_annotated/promoter_annotated.csv", "dataset/cis_annotated/enhancer_annotated.csv")
snps_in_cis_paths <- c("dataset/bg_entropy_data/snps_in_promoter.csv", "dataset/bg_entropy_data/snps_in_enhancer.csv")
...
expr_path <- "dataset/icgc_processed/icgc_exp_LIRI_JP.tsv"
