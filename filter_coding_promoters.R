...
promoter_path <- "dataset/input/raw/all_promoters_refseq.txt"
refseq_tss_path <- "dataset/input/RefSeq/refseq_TSS_hg19_170929.bed"
...
write.table(promoters_coding, "promoters_refseq_coding.txt", quote = F, row.names = F, col.names = F, sep = "\t")
